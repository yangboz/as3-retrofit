package eu.powdermonkey.composure
{
	...
	public class MixinFactory
	{
		...
		private var _proxies:Dictionary = new Dictionary()
		
		private var _loaders:Array = []
		
		public function MixinFactory()
		{
		}
		...
		public function mush(clazz:Class, constructorArguments:Array = null):*
		{
			...
			var object:Object = create(clazz, constructorArguments, interceptor)
			return object
		}
...
//			args = [proxyListener].concat(args);
			...
			if (args.length >= ClassUtility.MAX_CREATECLASS_ARG_COUNT)
			{
				...
				var createMethod:Function = proxyClass["__createInstance"];
